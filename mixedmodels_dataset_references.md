# Dataset Reference Table: nlme / lme4 / MixedModels.jl

Datasets carried across versions of nlme, lme4, and MixedModels.jl, with descriptions and APA citations.
...
> **Note:** The dataset itself originates from the 1988 Bangladesh Fertility Survey and is
...
No published citation. The dataset was created by the MixedModels.jl development team
as an internal benchmark for evaluating performance with three-way crossed vector random
effects. It is distributed as part of the MixedModelsDatasets.jl artifact system.

Bates, D., Alday, P. M., & Kokandakar, A. H. (2025). Mixed-model log-likelihood evaluation
via a blocked Cholesky factorization. *arXiv preprint arXiv:2505.11674*.
...
**Package origin:** MixedModels.jl / RePsychLing
...
> **See also:** Barr, D. J., Levy, R., Scheepers, C., & Tily, H. J. (2013). Random effects
...
> **See also:** Pinheiro, J. C., & Bates, D. M. (2000). *Mixed-effects models in S and
...
**Package origin:** Early lme4 (as `Mmmec`) / mlmRev / MixedModels.jl
...
factorial design manipulated primeâtarget relatedness (related vs. unrelated; P), target
...
responses to word targets in the 300–3,000 ms range yielded 16,409 analysable observations.
...
> **Note:** The user-provided hint listed the first author as "Matuschek"; the first author is
> Michael E. J. Masson. The initials M, R, K in `mrk17` refer to Masson, Rabe, and Kliegl.
> This is a replication of Masson & Kliegl (2013, *Journal of Experimental Psychology:
...
> **See also:** Pinheiro, J. C., & Bates, D. M. (2000). *Mixed-effects models in S and
> S-PLUS* (Appendix A.20). Springer. https://doi.org/10.1007/b98882
...
> **Note on documentation:** The lme4 help page contains a slight inaccuracy: sleep
> restriction began after day 2 (the baseline), not day 0 (see Belenky et al., 2003,
> p. 2, and lme4 GitHub issue #615).
...
(STAXI; anger), gender, behaviour type (btype), situation type (situ), mode, polytomous
response (resp: no/perhaps/yes), and a binary dichotomisation thereof (r2: N/Y). Originally
...
> **Note:** The original data collection is attributed to Vansteelandt, K. (2000).
